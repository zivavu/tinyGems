  ...
  return (
    <div className="container flex flex-col mx-auto px-4 py-12">
      <Typography variant="large" className="mb-20">
        ...
        for providing the privacy policy template, and letting me generate it for free, some smart people in suits tell me that it&apos;s
        necessary, and I want to be legit. Also sorry termly for converting the thing into .md, but I couldn&apos;t get it to work :(( .
        Don&apos;t sue me please. Just let me know if man did very horrible thing.
        <br />
        <br />
