					...
					{[
						{
							icon: Icons.music,
							title: 'Music',
							description: 'Share your melodies',
						},
						{
							icon: Icons.art,
							title: 'Drawings',
							description: 'Show your sketches',
						},
						{
							icon: Icons.pencil,
							title: 'Handcraft',
							description: 'Display your creations',
						},
					].map((category) => (
						<div
							key={category.title}
							className="bg-white dark:bg-gray-900 rounded-2xl p-6 text-center 
							hover:scale-105 transition-all shadow-sm hover:shadow-md 
							dark:shadow-rose-900/10">
