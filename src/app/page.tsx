...
export default function Home() {
  return (
    <main className="relative bg-stone-50 dark:bg-[#0a0a0a]">
      <section className={`min-h-screen flex items-center justify-center ${getSectionGradient('hero')}`}>
        <div className="z-20 max-w-6xl space-y-12 mx-auto flex flex-col items-center justify-center text-center">
          ...
          <Typography variant="h6">
            ...
            finding basement, <span className="text-purple-500 dark:text-purple-400">underground artists</span>, that value expression,
            realness and passion - over algorithm mastering.
            <br />
          </Typography>
      ...
      <section className={`py-32 px-6 ${getSectionGradient('features')}`}>
        <div className="max-w-5xl  mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="z-20 space-y-12">
            ...
            <div className="p-8 bg-white z-20 dark:bg-stone-900 rounded-3xl shadow-lg relative group before:absolute before:-inset-2 before:bg-purple-500/10 before:rounded-3xl">
      ...
      <section className={`px-6 relative pb-32 ${getSectionGradient('gems')}`}>
      ...
      <section className={`py-32 px-6 text-center ${getSectionGradient('cta')}`}>
