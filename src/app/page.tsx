      ...
      <main className="container px-8 pt-20 pb-32 mx-auto my-auto">
        <div className="mx-auto text-center">
          ...
          <Typography variant="p" className="mb-8 text-lg lg:px-28 md:px-6 sm:px-0">
            Welcome to tinyGems, a cozy corner of the internet, created for basement, underground artists that value expression and passion,
            over money.
            <br />
            It&apos;s hard to find You folks, but the things You create are one of the most precious gems in this tiny world. Keep it up!
          </Typography>
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto mt-16 max-w-6xl lg:grid-cols-3 md:grid-cols-2">
          {categories.map((category) => (
            ...
            >
              <DynamicIcon name={category.icon} className="mx-auto mb-4 w-8 h-8 text-rose-500 dark:text-rose-400" />
