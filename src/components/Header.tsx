        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex gap-4 items-center">
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link href="/login" className="text-gray-600 transition-colors hover:text-rose-500">
                  Sign in
                </Link>
                <Link href="/register" className="px-4 py-2 text-white bg-rose-500 rounded-full transition-colors hover:bg-rose-600">
                  Get Started
                </Link>
              </>
            )}
