...
import { FormTextErrorMessage } from '@/features/shared/components/forms/FormTextErrorMessage';
...
interface FindArtistStepProps {
  onContinue: (artistData: { platform: string; artistData: ExternalPlatformArtistData }) => void;
}
  ...
  return (
    <div className="space-y-5">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        {errorMessage && <FormTextErrorMessage message={errorMessage.toString()} />}
      </form>
